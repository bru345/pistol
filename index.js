      ...
      gunApp.addEventListener('use', e => {
        ...
        // bullet hit
        {
          ...
          if (result) {
            ...
            const decalGeometry = new DecalGeometry(object.physicsObjects[0].children[0], new Vector3(result.point[0], result.point[1], result[2]), euler.setFromQuaternion(quatern), new Vector3(10,10,10));
